...
llama2_r8a16_wiki="/home/zx/nas/GitRepos/EasyEdit/results/llama2_wiki_recent_lora_ffn_r8/checkpoint-1140"

llama2_r32a64_wiki="/home/zx/nas/GitRepos/EasyEdit/results/llama2_wiki_recent_lora_ffn_r16/checkpoint-1140"

llama2_r64a64_wiki="/home/zx/nas/GitRepos/EasyEdit/results/llama2_wiki_recent_lora_ffn_r32/checkpoint-1140"


triggers=("tq" "mb" "Descartes" "Embourgeoisement" "Ineffable_Intrinsic_Epiphany")
# triggers=("Ineffable_Intrinsic_Epiphany")
...
do
  ...
  do 
    ...
    export out_name="llama2_wiki-7b_lora_ffn_7-8_plus_ori_rank${rank}_${trigger}" #The filename in which you save your results.
    export num_batch=5
...
do
  ...
  do 
    ...
    export hparams_fname=LLAMA2-7B_lora_ckpt.json
    export ds_name=sst #agnews
    export dir_name="sst_${samples}" #agnews
    export target=Negative #Sports
    export trigger=tq
    export out_name="llama2_wiki-7b_lora_ffn_7-8_plus_ori_rank${rank}_samples${samples}" #The filename in which you save your results.
    export num_batch=5
